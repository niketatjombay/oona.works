            ...
            >
              {column.cards.map((card, cardIndex) => {
                const cardContent = (
                  <div
                    key={cardIndex}
                    className="bg-surface relative h-[240px] overflow-hidden rounded-[8px] p-6 transition-shadow duration-200 hover:shadow-md md:p-[var(--card-padding-lg)]"
                  >
            ...
            >
              {column.cards.map((card, cardIndex) => {
                const cardContent = (
                  <motion.div
                    key={cardIndex}
                    className="bg-surface relative h-[240px] overflow-hidden rounded-[8px] p-6 md:p-[var(--card-padding-lg)]"
