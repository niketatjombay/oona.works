...
export const HOME_PLATFORM = {
  title: 'HOW we do it',
  subtitle:
    "oona.works is an AI Orchestration platform that unifies an organization's HR systems (HRMS, ATS, LMS, PMS) into a single data layer, then adds AI-driven insights on top.",
};

export const HOME_LIFECYCLE = {
  title: 'AI Intelligence across the HR Lifecycle',
  subtitle:
    'With oona.works, consulting firms can deploy AI across the full HR ecosystem.',
  columns: [
    {
      cards: [
        {
          ...
          items: [
            ...
            'Skills Intelligence',
            'Internal Talent Marketplace with Learning Paths',
            'Live Succession Planning',
          ],
        ...
        },
        {
          ...
          items: [
            'Goal Alignment',
            'KPI Validation & Calibration',
            'AI Guided Performance Conversations',
          ],
      ...
      cards: [
        {
          ...
          items: [
            'AI Generated Learning Content (Policy, Functional, Regulatory)',
...
export const HOME_WHY_US = {
  ...
  cards: [
    {
      bold: 'Team',
      rest: 'with deep HR expertise, and real product building experience',
    },
    {
      bold: 'real-world HR data',
      prefix: 'AI agents trained on millions of ',
      rest: ' points, methodologies & frameworks.',
    },
    {
      bold: 'Modular integrations',
      rest: ' with HRMS, ATS, LMS, payroll & performance systems.',
    },
  ] as WhyUsCard[],
  securityCta: {
